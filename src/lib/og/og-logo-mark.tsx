const DEFAULT_LOGO_COLOR = "#334155"

type OgLogoMarkSharedProps = {
  color?: string
  idSuffix?: string
}

type OgLogoMarkProps = OgLogoMarkSharedProps & {
  width?: number
  height?: number
}

export function OgLogoMarkMaskDefs({
  idSuffix,
...
export function OgLogoMarkContent({
  color = DEFAULT_LOGO_COLOR,
  idSuffix = "default",
}: Readonly<OgLogoMarkSharedProps>) {
  ...
  return (
    <g>
      ...
      <g transform="matrix(1.0622435,0,0,1.0622435,-4.7870861,-15.119006)">
        ...
        />
        <path style={fill} d="m 292.84995,261.91664 h 43.92664 v -11.07332 h -43.92664 z" />
        <path
          style={fill}
        ...
        />
        <path style={fill} d="M 28.630105,280.24997 H 53.490093 L 79.523414,244.60999 H 53.41676 Z" />
        <path style={fill} d="M 5.0167838,258.10331 H 34.276769 V 247.90998 H 5.0167835 Z" />
        <path style={fill} d="M 5.0901168,241.23665 H 34.203436 V 230.89666 H 5.0901168 Z" />
        <g>
          <rect style={{ fill: color, stroke: "none" }} width="10" height="17.6" x="61.184383" y="219.23209" />
          <rect style={{ fill: color, stroke: "none" }} width="10" height="17.6" x="73.026443" y="219.23209" />
        </g>
        <circle
          style={{
            fill: "none",
      ...
      <g transform="matrix(0.74644869,0.20001032,-0.20001032,0.74644869,-85.713131,-160.66434)">
        <path style={{ fill: color, stroke: "none" }} d="m 634.3007,137.3986 h 75.76778 l -58.68283,94.33435 -59.55039,0.0433 z" />
        <path style={{ fill: color, stroke: "none" }} d="M 641.02971,205.38614 H 702.8911 L 591.35644,316.24753 Z" />
      </g>
...
export default function OgLogoMark({
  ...
  return (
    ...
    >
      <defs>
        <OgLogoMarkMaskDefs idSuffix={idSuffix} />
      </defs>
      <OgLogoMarkContent color={color} idSuffix={idSuffix} />
    </svg>
  )
}
